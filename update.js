...
void async function main( ) {
    ...
    const output    = [
        "```console",
        "$ curl -s https://raw.githubusercontent.com/PotatoRui/PotatoRui/master/hello.sh | sh",
        "",
        "__________       __          __        __________      .__ ",
        "\______   \_____/  |______ _/  |_  ____\______   \__ __|__|",
        " |     ___/  _ \   __\__  \\   __\/  _ \|       _/  |  \  |",
        " |    |  (  <_> )  |  / __ \|  | (  <_> )    |   \  |  /  |",
        " |____|   \____/|__| (____  /__|  \____/|____|_  /____/|__|",
        "                          \/                   \/          ",
        "├── From Philippines.",
        "├── Born on 2000.11.14",
        "└── Joined Github on 2017.02.17",
        "",
        `$ waka stats --user PotatoRui --from ${ new Date( Date.now( ) - 604800000 ).toISOString( ).split( "T" )[ 0 ] } --to ${ new Date( ).toISOString( ).split( "T" )[ 0 ] }`,
        "",
    ]
    ...
    output.push(
        ...
        "```",
        `###### This presentation is [updated](https://github.com/PotatoRui/PotatoRui/blob/main/update.js) automatically every 2 hours, most recently on ${ lastUpdate } ( UTC±2 )`
    );
